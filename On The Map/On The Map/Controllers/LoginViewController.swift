...
class LoginViewController: UIViewController, UITextFieldDelegate {
    ...
    let signUpUrl = Client.Endpoints.udacitySignUp.url
    ...
    @IBAction func login(_ sender: UIButton) {
        setLoggingIn(true)
        Client.login(email: self.emailField.text ?? "", password: self.passwordField.text ?? "", completion: handleUserSession(success:error:))
    }
